...
-- =====================================================================
-- ATTENDAI DATABASE RESET SCRIPT
-- Use this to drop all tables and start fresh
-- =====================================================================

-- Drop all tables (with CASCADE to drop dependencies)
...
-- Drop the uuid-ossp extension if needed (optional)
-- DROP EXTENSION IF EXISTS "uuid-ossp";

-- Now re-run the complete schema
-- =====================================================================
